...
export default function AboutPage() {
  return (
    <div className="bg-gray-50 flex p-10 mt-10 gap-6 justify-center">
      {" "}
      <div className="flex flex-col gap-4 w-4/12">
        <h1 className="text-4xl font-bold text-gray-800">About Me</h1>
        <p>
          I'm a passionate developer with a love for creating innovative web
          solutions that make a real difference. With 5+ years of experience in
          full-stack development, I specialize in turning complex problems into
      ...
      <div className="shadow-md rounded-lg p-8 w-4/12 bg-white">
        ...
        <div className="space-y-4 bg-white ">
          <div className="flex justify-between border-b pb-2 bg-white">
            {" "}
            <span className="font-medium text-gray-600 bg-white">Location</span>
            <span className="text-gray-800 bg-white">Stockholm, Järfälla</span>
          </div>
          <div className="flex justify-between border-b pb-2 bg-white">
            {" "}
